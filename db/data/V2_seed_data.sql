...
('Lasanha Bolonhesa', 45.00, 'Massa'),
('Risoto de Camarão', 55.00, 'Massa'),
('Coca-Cola Zero', 6.00, 'Bebida'),
('Pudim', 12.00, 'Sobremesa');

INSERT INTO funcionario (nome, cpf, salario, tipo_funcionario)
VALUES ('Garcom', '123.456.789-00', 1500.00, 'GARCOM');
INSERT INTO garcom (id_funcionario, turno, comissao) VALUES (1, 'Noite', 10.0);

INSERT INTO funcionario (nome, cpf, salario, tipo_funcionario)
VALUES ('Cozinheiro', '987.654.321-00', 5000.00, 'COZINHEIRO');
INSERT INTO cozinheiro (id_funcionario, especialidade) VALUES (2, 'Massas');

INSERT INTO pedido (data_pedido, id_cliente, id_mesa, id_funcionario)
VALUES (CURRENT_TIMESTAMP, 1, 1, 1);

INSERT INTO item_pedido (id_pedido, id_prato, quantidade, observacao) VALUES
(1, 1, 1, 'Sem muito queijo'),
(1, 3, 2, 'Com gelo e limão');
